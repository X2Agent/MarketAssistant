...
/// </summary>
internal sealed class PromptCacheWriteFilter : CacheBaseFilter, SK.IFunctionInvocationFilter
{
    private readonly IEmbeddingGenerator<string, Embedding<float>> _embeddingGenerator;
    private readonly VectorStore _vectorStore;

    public PromptCacheWriteFilter(IEmbeddingFactory embeddingFactory, VectorStore vectorStore)
    {

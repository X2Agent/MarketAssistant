...
public sealed class AShareFinancialTools : IShareFinancialTools
{
    ...
    public AShareFinancialTools(IHttpClientFactory httpClientFactory, IUserSettingService userSettingService)
    {
    ...
    public async Task<List<BalanceSheet>> GetBalanceSheetAsync([Description("股票代码")] string assetSymbol)
    {
        try
        {
    ...
    public async Task<List<IncomeStatement>> GetIncomeStatementAsync([Description("股票代码")] string assetSymbol)
    {
        try
        {
            var stockCode = StockSymbolConverter.ToZhiTuFormat(assetSymbol);
    ...
    public async Task<List<CashFlowStatement>> GetCashFlowStatementAsync([Description("股票代码")] string assetSymbol)
    {
        try
        {
            var stockCode = StockSymbolConverter.ToZhiTuFormat(assetSymbol);
    ...
    public async Task<List<FinancialRatios>> GetFinancialRatiosAsync([Description("股票代码")] string assetSymbol)
    {
        try
        {
            var stockCode = StockSymbolConverter.ToZhiTuFormat(assetSymbol);
    ...
    public async Task<List<CapitalStructure>> GetCapitalStructureAsync([Description("股票代码")] string assetSymbol)
    {
        try
        {
            var stockCode = StockSymbolConverter.ToZhiTuFormat(assetSymbol);
